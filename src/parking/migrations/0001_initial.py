    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('Reserved', 'Reserved'), ('Available', 'Available')], default='Available', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_date_start', models.DateField()),
                ('booking_date_end', models.DateField()),
                ('booking_time_start', models.TimeField()),
                ('booking_time_end', models.TimeField()),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parking.Location')),
